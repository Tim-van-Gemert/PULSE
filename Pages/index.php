...
<head>
    <link rel="apple-touch-icon" href="PULSE/Media/circle.grid.cross.fill.svg">
...
<body class="dark:bg-black bg-white mt-14 ">
...
<?php include('header.php') ?>
    ...
    <div class="bg-[#f9f3f3] justify-around flex  dark:text-white mx-5 px-4 py-2 mt-4 rounded-xl mb-36  dark:bg-slate-900 ">
        <a class="text-white text-center text-xs ">Developed by bit in amsterdam</a>
    </div>

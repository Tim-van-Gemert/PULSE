...
<body class="dark:bg-black bg-white h-[100vh]">
    ...
    <div class="flex m-6 justify-center flex-col">
        ...
        <div class="rounded-lg w-55 h-64 bg-slate-100 rounded-3xl">
            <h5 class="text-2xl font-bold font-mono pt-3 pl-3">RPE Survey</h5>
            <p class="pt-4 pl-3">Let us know how your workout went.</p>
        ...
        <div class="rounded-lg w-55 h-64 bg-slate-100 rounded-3xl mt-6">
            <h5 class="text-2xl font-bold font-mono pt-3 pl-3">Mental Health Survey</h5>
            <p class="pt-4 pl-3">Let us know how you have been feeling <br> lately.</p>
            <a href="#" class="w-32 h-14">
